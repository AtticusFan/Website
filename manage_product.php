    ...
    $account = $_SESSION['account'];
        if ($result = mysqli_query($link, "SELECT * FROM products")) {
            while ($row = mysqli_fetch_assoc($result)) {
                $photo = "$row[photo]";
                $rows .= "<tr><td><img src='$photo' width='100px'/>" . $row["name"] . "</td><td style='text-align:center;vertical-align:middle'>$" . $row["price"] . "</td><td style='text-align:center;vertical-align:middle'>" . $row["stock"] . "</td></tr>";
            }
        ...
        <div class="container">
            ...
            <div class="col-lg-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">商品庫存管理</li>
                </ul>
            </div>
        </div>
    </div>
