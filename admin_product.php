                ...
                <div class="row">
                        ...
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="manage_message.php"> <i class="fa fa-bullhorn"></i> </a>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="manage_product.php"><i class="fa fa-truck" style="font-size:40px"></i> </a>
                                </div>
                                <div class="service-desc">
                                    <h4>查詢商品庫存</h4>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="add_product.php"><i class="fa fa-plus" style="font-size:40px"></i> </a>
                                </div>
                                <div class="service-desc">
                                    <h4>新增商品品項</h4>
                                </div>
