                                    ...
                                    <div class="list-view-box">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    <h4><?php echo $row['name']; ?></h4>
                                                    <h5> <del>$ 2077</del> $<?php echo $row['price']; ?></h5>

                                                    <li>◆100%無穀 低敏再升級</li>
                                                    <li>◆富含營養海藻、鮭魚油等超級食物</li>
                                                    <li>◆不含副產品、人工香料色素</li>
                                                    <li>◆強化骨骼、關節，保健新血管</li>
                                    ...
                                    <div class="list-view-box">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    <h4><?php echo $row['name']; ?></h4>
                                                    <h5> <del>$ 3120</del> $<?php echo $row['price']; ?></h5>

                                                    <li>◆Romer-G 鍵軸</li>
                                                    <li>◆鋁鎂合金頂蓋、懸浮按鍵設計</li>
                                                    <li>◆26Keys Rollover無衝</li>
                                                    <li>◆附額外遊戲專屬鍵帽&拔鍵器</li>
